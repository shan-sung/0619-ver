...
import com.example.myapplication.data.api.ChatApiService
import com.example.myapplication.data.api.ForYouApiService
import com.example.myapplication.data.api.FriendApiService
...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideForYouApiService(
        @Named("TripsRetrofit") retrofit: Retrofit
    ): ForYouApiService {
        return retrofit.create(ForYouApiService::class.java)
    }
